...
0.10.0      val `zio-json-golden`    = mvn"dev.zio::zio-json-golden::${Versions.`zio-json`}"
      ...
      def managed: Seq[Dep] =
0.10.0        Seq(zio, `zio-streams`, `zio-test`, `zio-test-magnolia`, `zio-test-sbt`, `zio-json`, `zio-json-golden`) ++
