...
release line — the topmost undated heading is the number a build is heading toward — and **git** supplies
...
`MorphirVersionedModule` for where the three streams are wired.
