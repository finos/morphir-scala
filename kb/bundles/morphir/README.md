...
| [`morphir-scala`](./morphir-scala/) | this repository | What morphir-scala does today and why, alongside non-authoritative draft Design Notes and research for work still in refinement. |
