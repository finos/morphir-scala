...
| [`morphir-ir-v4-draft`](./morphir-ir-v4-draft/) | [finos/morphir](https://github.com/finos/morphir) `docs/spec/draft/` | The draft specification for Morphir IR format version 4. Not yet active; subject to change. |
