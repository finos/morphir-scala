...
| [`morphir/morphir-scala`](./bundles/morphir/morphir-scala/) | What morphir-scala does today and why, alongside non-authoritative draft Design Notes and research for work still in refinement. |
