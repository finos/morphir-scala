...
| [`morphir/morphir-scala`](./bundles/morphir/morphir-scala/) | What morphir-scala does today — the Scala bindings, JVM tooling and build for Morphir — and the decisions behind it. |
