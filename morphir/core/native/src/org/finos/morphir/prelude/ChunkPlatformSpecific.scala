...
/**
 * Ported from ZIO:
 * https://github.com/zio/zio/blob/series/2.x/core/native/src/main/scala/zio/ChunkPlatformSpecific.scala
 */
...
private[prelude] trait ChunkPlatformSpecific {

  private[prelude] object Tags {
