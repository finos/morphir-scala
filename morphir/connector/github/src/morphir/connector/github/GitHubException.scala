...
object GitHubException:
  ...
  /**
   * Map an HTTP status and response detail to a typed failure. A 403 is rate-limited only when the detail looks like
   * GitHub's primary or secondary rate-limit wording; other 403s are Forbidden.
   */
