...
object ModuleDefinitionJsonCodecProviderSpec
  ...
  def spec = suite("ModuleDefinitionJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Module.Definition[Literal, scala.Unit]])
  )
}
