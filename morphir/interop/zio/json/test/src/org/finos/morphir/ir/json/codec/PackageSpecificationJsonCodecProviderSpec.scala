...
object PackageSpecificationJsonCodecProviderSpec
  ...
  def spec = suite("PackageSpecificationJsonCodecProviderSpec")(
    goldenTest(DeriveGen[PackageModule.Specification[Literal]])
  )
}
