...
object ConstructorsJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("ConstructorsJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Constructors[Literal]])
  )
}
