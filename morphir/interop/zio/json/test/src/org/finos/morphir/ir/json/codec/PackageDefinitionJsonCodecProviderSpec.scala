...
object PackageDefinitionJsonCodecProviderSpec
  ...
  def spec = suite("PackageDefinitionJsonCodecProviderSpec")(
    goldenTest(DeriveGen[PackageModule.Definition[Literal, scala.Unit]])
  )
}
