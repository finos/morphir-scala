...
object LiteralJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("LiteralJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Literal])
  )
}
