...
object TypeDefinitionJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("TypeDefinitionJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Definition[Literal]])
  )
}
