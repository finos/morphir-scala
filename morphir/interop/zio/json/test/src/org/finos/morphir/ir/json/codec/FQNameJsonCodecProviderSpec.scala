...
object FQNameJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("FQNameJsonCodecProviderSpec")(
    goldenTest(DeriveGen[FQName])
  )
}
