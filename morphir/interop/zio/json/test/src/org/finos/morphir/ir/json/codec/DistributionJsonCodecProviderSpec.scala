...
object DistributionJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("DistributionJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Distribution])
  )
}
