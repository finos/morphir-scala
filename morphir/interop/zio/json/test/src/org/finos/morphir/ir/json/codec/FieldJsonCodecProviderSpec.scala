...
object FieldJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("FieldJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Field[Literal]])
  )
}
