...
import java.io.File
import org.finos.morphir.ir.generator.LiteralDeriveGen
...
object LiteralCharJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("LiteralCharJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Literal.CharLiteral])
  )
}
