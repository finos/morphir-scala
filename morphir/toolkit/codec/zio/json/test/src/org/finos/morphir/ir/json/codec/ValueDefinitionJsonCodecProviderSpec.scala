...
object ValueDefinitionJsonCodecProviderSpec
  ...
  def spec = suite("ValueDefinitionJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Value.Definition[scala.Unit, Literal]])
  )
}
