  ...
  def spec =
    suite("Json Evaluation")(
      suite("Constructor Tests")(
        ...
        test("One Arg") {
          val actual = runTest[(String, List[Any])]("constructorTests", "constructorTests", "constructorOneArgAppliedTest")
          val expected = ("OneArg", List(5))
          assertTrue(actual == expected)
        },
        test("Two Arg") {
          val actual = runTest[(String, List[Any])]("constructorTests", "constructorTests", "constructorTwoArgAppliedTest")
          val expected = ("TwoArg", List(5, "Red"))
          assertTrue(actual == expected)
        },
        test("Two Arg Curried") {
          val actual = runTest[(String, List[Any])]("constructorTests", "constructorTests", "constructorTwoArgCurriedTest")
      ...
      suite("Destructure Tests")(
        ...
        test("Tuple Twice") {
          val actual = runTest[(String, Long, (Long, String))]("destructureTests", "destructureTests", "destructureTupleTwiceTest")
      ...
      suite("Let Definition") (
        ...
        test("Simple Function") {
          val actual = runTest[(Long, Long)]("letDefinitionTests", "letDefinitionTests", "letDefinitionSimpleFunctionTest")
          val expected = (3, 3)
          assertTrue(actual == expected)
        },
        test("Two Argument Function") {
          val actual = runTest[(Long, Long)]("letDefinitionTests", "letDefinitionTests", "letDefinitionTwoArgFunctionFunctionTest")
          val expected = (3, 2)
          assertTrue(actual == expected)
        },
        ...
        test("Apply Twice") {
          val actual = runTest[((Long, Long), (Long, Long))]("letDefinitionTests", "letDefinitionTests", "letDefinitionApplyTwiceTest")
        ...
        test("Lexical cope") {
          val actual = runTest[(Long, (Long, Long))]("letDefinitionTests", "letDefinitionTests", "letDefinitionScopeTest")
          val expected = (3, (4, 5))
          assertTrue(actual == expected)
        },
      ),
      ...
      suite("Native References")(
        test("Map") {
          val actual = runTest[List[(Long, Long)]]("nativeReferenceTests", "nativeReferenceTests", "nativeReferenceMapTest")
      ...
      suite("Patern Matching")(
        ...
        test("Repeated As") {
          val actual = runTest[(Long, (Long, Long))]("patternMatchTests", "patternMatchTests", "patternMatchRepeatedAsTest")
          val expected = (2, (1, 2))
          assertTrue(actual == expected)
        },
      ),
      suite("Records")(
        ...
        test("Nested Record") {
          ...
          val expected = Map("name" -> "Dogs", "records" -> List(Map("name"->"Ponyo", "number" -> 3), Map("name"->"Soso", "number" -> 3)))
          assertTrue(actual == expected)
        },
      ...
      suite("References To user Defined Members")(
        test("Reference to value") {
          val actual = runTest[Long]("userDefinedReferences", "userDefinedReferenceTests", "userDefinedReferenceValueTest")
          val expected = 5
          assertTrue(actual == expected)
        },
        test("Curried Function Application") {
          val actual = runTest[String]("userDefinedReferences", "userDefinedReferenceTests", "userDefinedReferenceCurriedTest")
          val expected = "Correct"
          assertTrue(actual == expected)
        },
        test("Simple Function Application") {
          val actual = runTest[(Long, Long)]("userDefinedReferences", "userDefinedReferenceTests", "userDefinedReferenceSimpleFunctionTest")
          val expected = (1, 2)
          assertTrue(actual == expected)
        },
        test("Calling public function which calls private function") {
          val actual = runTest[Long]("userDefinedReferences", "userDefinedReferenceTests", "userDefinedReferencePublicPrivateTest")
          val expected = 10
          assertTrue(actual == expected)
        },
        test("Reference to Record") {
          val actual = runTest[String]("userDefinedReferences", "userDefinedReferenceTests", "userDefinedReferenceRecordTest")
          val expected = "Tom Tit Tot"
          assertTrue(actual == expected)
        },
        test("Reference to Union Type") {
          val actual = runTest[Long]("userDefinedReferences", "userDefinedReferenceTests", "userDefinedReferenceUnionTest")
          val expected = -6
          assertTrue(actual == expected)
        },
