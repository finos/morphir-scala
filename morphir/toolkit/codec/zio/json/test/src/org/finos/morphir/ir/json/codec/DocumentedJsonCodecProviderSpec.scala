...
object DocumentedJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("DocumentedJsonCodecProviderSpec")(
    goldenTest(DeriveGen[Documented[Literal]])
  )
}
