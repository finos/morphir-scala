...
object QNameJsonCodecProviderSpec extends MorphirJsonBaseSpec with MorphirIRDeriveGen with MorphirJsonSupport {
  ...
  def spec = suite("QNameJsonCodecProviderSpec")(
    goldenTest(DeriveGen[QName])
  )
}
