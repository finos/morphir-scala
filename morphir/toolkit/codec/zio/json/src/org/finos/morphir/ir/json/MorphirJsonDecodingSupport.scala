...
trait MorphirJsonDecodingSupport {
  ...
  def v[TA: JsonDecoder, VA: JsonDecoder] = zio.json.TagBasedParser[Value[TA, VA]] {
  ...
  implicit def valueDecoder[TA: JsonDecoder, VA: JsonDecoder]: JsonDecoder[Value[TA, VA]] = v
