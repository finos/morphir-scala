...
letDefinitionMakeTupleTest ctx =
    test ctx <|
        let
            x =
                1
...
letDefinitionSimpleFunctionTest ctx =
    test ctx <|
        let
            f x =
                ( x, x )
...
letDefinitionTwoArgFunctionFunctionTest ctx =
    test ctx <|
        let
            f x y =
                ( y, x )
...
letDefinitionApplyTwiceTest ctx =
    test ctx <|
        let
            f x y =
                ( y, x )
