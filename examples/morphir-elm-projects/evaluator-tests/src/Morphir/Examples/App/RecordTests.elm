...
recordFieldFromBoundTest ctx =
    test ctx <|
        let
            myRecord =
                { name = "Correct", number = 0 }
        in
        myRecord.name
...
fieldFunctionApplyTwiceTest ctx =
    test ctx <|
        let
            record1 =
                { name = "Correct", number = 1 }

            record2 =
                { name = "Correct", number = 2 }
...
fieldFunctionUnappliedTest ctx =
    test ctx <|
        .number
...
recordSimpleTest ctx =
    test ctx <|
        { name = "Fido", number = 5 }


type alias NestedRecordType =
    { name : String, records : List RecordType }
